...
export function loadQuestion20() {
    ...
    questionTwoBox.innerHTML = "20. Remove the MooMail shortcut from your browser page.";
...
export function question20Select() {
    const body = document.getElementById("assessment-body");
    const infoBar = document.getElementById("info-bar");
    ...
    hintButton.addEventListener('click', function() {
        ...
        hintText.innerHTML = "<span style='font-size: 24px;'><b>HINT</b></span><br>The MooMail shortcut can be found next to the button used to add shortcuts.  If you select the right item, an x should appear on top of it.";
